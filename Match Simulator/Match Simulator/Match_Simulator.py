...
def main():
    ...
    #----- Simulator Metrics for Normal DAA/LMF -----
    #calcSimulatorMetrics('dense_candidate_prefs.csv', 'dense_employer_prefs.csv', 'candidate_simulated_matches.csv', 'employer_simulated_matches.csv', 3, 10)
    #return

    #----- Simulator Metrics for Mixed Algo -----
    calcMixedSimulatorMetrics('dense_candidate_prefs.csv', 'dense_employer_prefs.csv', 'lmf_dense_candidate_prefs.csv', 'lmf_dense_employer_prefs.csv', 'candidate_simulated_matches.csv', 'employer_simulated_matches.csv', 3, 10)
    #return
